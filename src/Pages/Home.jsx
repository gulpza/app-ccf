    ...
    <div className="min-vh-100" style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #e0e7ef 100%)' }}>
      <div className="container py-5">
        <div className="text-center mb-4">
          ...
          <h1 className="fw-bold">ระบบรายงาน</h1>
        ...
        <div>
          <h3 className="fw-bold mb-3 text-success">
            <i className="fas fa-clipboard-list me-2"></i>รายงานทั่วไป
          </h3>
            ...
            <Link to="/pick-daily-member-record" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fas fa-clipboard-list fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/pick-daily-farm" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fas fa-calendar-day fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/pick-daily-member-price" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fas fa-user fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/pick-daily-farm-veg" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fa-seedling fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/daily-shipping" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fa-truck-fast fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/emp-sorting" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fa-chart-gantt fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/hair-rolling" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fa-wind fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/random-test" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fas fa-shuffle fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/random-test-pick" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fas fa-paper-plane fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/ranking" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fas fa-trophy fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/yield" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fas fa-seedling fa-3x mb-3 text-success"></i>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <Link to="/farm-weight-report" className="text-decoration-none">
              <div className="card h-100 shadow-sm border-0 rounded-4 hover-shadow">
                <div className="card-body text-center">
                  <i className="fa-solid fas fa-truck fa-3x mb-3 text-success"></i>
